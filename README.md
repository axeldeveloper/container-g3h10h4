...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-g3h10h4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-g3h10h4.containers.anotherwebservice.com/
...
```
git clone git@github.com:axeldeveloper/container-g3h10h4.git
cd container-g3h10h4
```
...
```
docker attach container-g3h10h4
```
